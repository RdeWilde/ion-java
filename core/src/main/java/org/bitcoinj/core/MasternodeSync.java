    ...
    void clearFulfilledRequest()
    {
        ...
        try {
            ...
            //BOOST_FOREACH(CNode* pnode, vNodes)
            {
                ...
                pnode.clearFulfilledRequest("mnw");
        ...
        try {
            ...
            for (Peer pnode : context.peerGroup.getConnectedPeers()) {
                ...
                if (RequestedMasternodeAssets == MASTERNODE_SYNC_LIST) {
                    ...
                    if (pnode.hasFulfilledRequest("mnget")) continue;
                    pnode.fulfilledRequest("mnget");
                ...
                if (RequestedMasternodeAssets == MASTERNODE_SYNC_MNW) {
                    ...
                    if (pnode.hasFulfilledRequest("mnw")) continue;
                    pnode.fulfilledRequest("mnw");
