...
public class TransactionLockVote extends Message implements Serializable {
    ...
    protected void parse() throws ProtocolException {
        ...
        confirmedHeight = (int)readUint32();

// TODO rdw new dash after refactoring
...
//        outpointMasternode.bitcoinSerialize(stream);
        ...
        uint32ToByteStreamLE(confirmedHeight, stream);
...
//            return false;
//        }
// TODO rdw FIXME pubKeyMasternode is null
//        java.lang.NullPointerException: Attempt to read from field 'org.bitcoinj.core.PublicKey org.bitcoinj.core.Masternode.pubKeyMasternode' on a null object reference
