 ...
 *
 * For pay-to-address and pay-to-pubKeyCollateralAddress transactions it will have only a single key and CHECKSIG program as redeemScript.
...
public class RedeemData {
    ...
    /**
     * Creates RedeemData for pay-to-address or pay-to-pubKeyCollateralAddress input. Provided key is a single private key needed
